...
permalink: /day3.html
tags: ["Computer Vision", "Files", "I/O" ]
...
reflection: |
  Computer Vision helped me understand how it is used in our daily life such as driving a Tesla, fingerprint and Face ID in phones and many more. Virtual escape room game sharpened my ability to think critically, divide tasks and share ideas. I am not that good with creating files in Python. I got a chance to learn about topics like introduction to file, input and output. This session definitely helped me with understanding files, I/O and sets in Python. Overall, it was a good learning.
---
